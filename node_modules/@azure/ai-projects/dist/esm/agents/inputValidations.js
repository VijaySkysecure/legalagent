...
export function validateVectorStoreDataType(data_sources) {
...
export function validateToolResources(toolResource) {
...
export function validateVectorStoreId(vectorStoreId) {
    if (!vectorStoreId) {
...
export function validateFileStatusFilter(filter) {
...
export function validateTruncationStrategy(value) {
